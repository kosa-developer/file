            ...
            <ul class="nav navbar-nav pull-right">
                ...
                <li class="dropdown dropdown-extended dropdown-notification" id="header_notification_bar">
                    <a href="index.php?page=shared_files" class="dropdown-toggle" data-hover="dropdown" data-close-others="true">
                        ...
                        <span id="notification_header" class="badge orange-bgcolor"> <?php
                ...
                <li class="dropdown dropdown-extended dropdown-inbox" id="header_inbox_bar">
                    <a href="index.php?page=dashboard" class="dropdown-toggle"  data-hover="dropdown" data-close-others="true">
                        ...
                        <span id="message_header" class="badge cyan-bgcolor"> <?php echo DB::getInstance()->displayTableColumnValue("select count(Id) as pendig_messages from messaging where Receiver_id='$recz_id' and Status='1' ", "pendig_messages");
                            ?> </span>
                    </a>
                </li>
